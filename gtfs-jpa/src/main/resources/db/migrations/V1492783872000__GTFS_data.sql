...
CREATE PROCEDURE gtfs_data()
    ...
    BEGIN
        ...
        CREATE TABLE IF NOT EXISTS `gtfs_trips_shapes` (
            `trips_id`  BIGINT(20) NOT NULL,
            `shapes_id` BIGINT(20) NOT NULL,
            `sequence`  INT(11)    NOT NULL,
            PRIMARY KEY (`trips_id`, `sequence`),
            ...
            CONSTRAINT `FKs9arv5aw1kf3oiqsespd9m0ea` FOREIGN KEY (`trips_id`) REFERENCES `gtfs_trips` (`id`)
        );
    END $$
